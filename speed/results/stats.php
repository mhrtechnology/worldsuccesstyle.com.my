...
<html>
    ...
    <head>
        <title>WORLD SUCCESS STYLE Speed Test - Stats</title>
        <style type="text/css">
            html,
            body {
                margin: 0;
    ...
    <body>
        <h1>WORLD SUCCESS STYLE Speed Test - Stats</h1> <?php
        if (!isset($stats_password) || $stats_password === 'PASSWORD') {
            ?> Please set $stats_password in telemetry_settings.php to enable access. <?php
                ...
                foreach ($speedtests as $speedtest) {
                    ?> <table>
                        ...
                        <tr>
                            ...
                            <td> <?= htmlspecialchars($speedtest['ip'], ENT_HTML5, 'UTF-8') ?><br /> <?= htmlspecialchars($speedtest['ispinfo'], ENT_HTML5, 'UTF-8') ?> </td>
                        </tr>
                        <tr>
                            <th>User agent and locale</th>
                            <td><?= htmlspecialchars($speedtest['ua'], ENT_HTML5, 'UTF-8') ?><br /> <?= htmlspecialchars($speedtest['lang'], ENT_HTML5, 'UTF-8') ?> </td>
                        </tr>
                        <tr>
